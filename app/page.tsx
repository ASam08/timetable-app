...
export default function Home() {
  ...
  return (
    <div className="bg-stone-300 dark:bg-gray-950 min-h-screen">
      <div className="flex flex-row mx-auto items-center p-6 bg-stone-300 dark:bg-black">
        <main className="flex">
      ...
      <div className="p-8">
      <div className={`flex flex-col flex-1 ${rotatePositive} w-64 rounded-xl p-8 border-2 justify-self-center text-center border-stone-600 dark:border-gray-700`}>
